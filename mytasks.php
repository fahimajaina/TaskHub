...
if (isset($_POST['update_status']) && !empty($_POST['taskId'])) {
    ...
    try {
        ...
        if ($checkStmt->rowCount() > 0) {
            ...
            $_SESSION['error'] = "Unauthorized access to task";
        }
...
function isOverdue($dueDate, $status) {
    if ($status === 'Completed' || empty($dueDate)) {
        return false;
    }
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-links" id="navLinks">
      ...
      <a href="mytasks.php" class="trigger active">
  ...
  <main class="main-content" id="mainContent">
    <h4 class="mb-4 heading-colored">
      <span class="material-icons me-2" style="vertical-align: middle;">task</span> My Tasks
    </h4>
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Tasks Assigned to Me</h5>
        ...
        <table class="table align-middle text-center">
          ...
          <tbody>
            ...
            <tr <?php echo $overdue ? 'class="overdue"' : ''; ?>>
              ...
              <td>
                <button class="btn btn-view btn-action" data-bs-toggle="modal" data-bs-target="#statusModal<?php echo $task['id']; ?>">
            ...
            ?>
            <tr>
              <td colspan="7" class="text-center">No tasks assigned to you yet</td>
            </tr>
            <?php endif; ?>
          </tbody>
        </table>
