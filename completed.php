...
<head>
  <meta charset="UTF-8">
  <title>Completed Tasks | TaskHub</title>
  ...
  <main class="main-content" id="mainContent">
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Successfully Finished Tasks</h5>
        ...
        <table class="table align-middle text-center">
          ...
          <tbody>
            ...
            <tr class="completed">
              ...
              <td><?php echo htmlspecialchars(date('Y-m-d', strtotime($task['updated_at']))); ?></td>
            </tr>
            ...
            <tr>
              <td colspan="6" class="text-center">
                <div style="padding: 40px 0;">
                  ...
                  <p class="mt-3 mb-0" style="font-size: 18px; font-weight: 600; color: #1f2a35;">No completed tasks yet</p>
                  <p class="text-muted">Complete your tasks to see them here!</p>
                </div>
              </td>
            </tr>
            <?php endif; ?>
