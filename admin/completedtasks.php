...
// Fetch completed tasks with user information
try {
...
<head>
  <meta charset="UTF-8">
  <title>Completed Tasks | TaskHub Admin</title>
...
<body>
  ...
  <main class="main-content" id="mainContent">
    <h4 class="mb-4 heading-colored">
      <span class="material-icons me-2" style="vertical-align: middle; color: #28a745;">check_circle</span> Completed Tasks
    </h4>
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Successfully Completed Tasks</h5>
              ...
              <td>
                <?php 
                  if (!empty($task['updated_at'])) {
                    echo htmlspecialchars(date('Y-m-d H:i', strtotime($task['updated_at'])));
                  } else {
            ...
            <tr>
              <td colspan="8" class="text-center">
                <div style="padding: 40px 0;">
                  <span class="material-icons" style="font-size: 60px; color: #6c757d;">assignment</span>
                  <p class="mt-3 mb-0" style="font-size: 18px; font-weight: 600; color: #1f2a35;">No completed tasks</p>
                  <p class="text-muted">Tasks will appear here once they are marked as completed.</p>
                </div>
              </td>
            </tr>
            <?php endif; ?>
