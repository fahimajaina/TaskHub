...
if (isset($_POST['update_status']) && !empty($_POST['taskId'])) {
    ...
    header("Location: no-deadline.php");
    exit();
}
...
// Fetch tasks with no deadline with user information
try {
...
<head>
  <meta charset="UTF-8">
  <title>No Deadline | TaskHub Admin</title>
...
<body>
  ...
  <main class="main-content" id="mainContent">
    <h4 class="mb-4 heading-colored">
      <span class="material-icons me-2" style="vertical-align: middle; color: #17a2b8;">event_busy</span> Tasks Without Deadline
    </h4>
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Tasks Without Specific Deadline</h5>
        ...
        <table class="table align-middle text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span class="badge bg-info text-dark">No Deadline</span>
              </td>
              <td>
            ...
            <tr>
              <td colspan="8" class="text-center">
                <div style="padding: 40px 0;">
                  <span class="material-icons" style="font-size: 60px; color: #28a745;">schedule</span>
                  <p class="mt-3 mb-0" style="font-size: 18px; font-weight: 600; color: #1f2a35;">No tasks without deadline</p>
                  <p class="text-muted">All tasks have been assigned specific deadlines.</p>
                </div>
              </td>
            </tr>
            <?php endif; ?>
