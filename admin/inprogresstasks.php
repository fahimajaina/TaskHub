...
if (isset($_POST['update_status']) && !empty($_POST['taskId'])) {
    ...
    header("Location: inprogresstasks.php");
    exit();
}
...
// Fetch in progress tasks with user information
try {
...
<head>
  <meta charset="UTF-8">
  <title>In Progress Tasks | TaskHub Admin</title>
...
<body>
  ...
  <main class="main-content" id="mainContent">
    <h4 class="mb-4 heading-colored">
      <span class="material-icons me-2" style="vertical-align: middle; color: #ffc107;">autorenew</span> Tasks In Progress
    </h4>
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Currently Active Tasks</h5>
            ...
            <tr>
              <td colspan="8" class="text-center">
                <div style="padding: 40px 0;">
                  <span class="material-icons" style="font-size: 60px; color: #17a2b8;">hourglass_empty</span>
                  <p class="mt-3 mb-0" style="font-size: 18px; font-weight: 600; color: #1f2a35;">No tasks in progress</p>
                  <p class="text-muted">Tasks being worked on will appear here.</p>
                </div>
              </td>
            </tr>
            <?php endif; ?>
