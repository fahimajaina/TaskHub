...
// Fetch tasks due today with user information
try {
...
<head>
  <meta charset="UTF-8">
  <title>Due Today | TaskHub Admin</title>
...
<body>
  ...
  <main class="main-content" id="mainContent">
    <h4 class="mb-4 heading-colored">
      <span class="material-icons me-2" style="vertical-align: middle; color: #ffc107;">today</span> Tasks Due Today
    </h4>
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Tasks Requiring Attention Today</h5>
              ...
              <td>
                <?php 
                  if (!empty($task['due_date'])) {
                    ...
                    echo '<br><span class="badge bg-warning text-dark">Due Today</span>';
                  } else {
            ...
            <tr>
              <td colspan="8" class="text-center">
                <div style="padding: 40px 0;">
                  ...
                  <p class="mt-3 mb-0" style="font-size: 18px; font-weight: 600; color: #1f2a35;">No tasks due today</p>
                  <p class="text-muted">All caught up! No pending tasks are due today.</p>
                </div>
              </td>
            </tr>
            <?php endif; ?>
