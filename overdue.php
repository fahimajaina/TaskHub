...
<head>
  <meta charset="UTF-8">
  <title>Overdue Tasks | TaskHub</title>
  ...
  <main class="main-content" id="mainContent">
    ...
    <div class="card p-4">
      ...
      <div class="alert-info-custom mb-4">
        ...
        <strong>Attention:</strong> You have <?php echo count($tasks); ?> overdue task<?php echo count($tasks) != 1 ? 's' : ''; ?>. Please complete them as soon as possible.
      </div>
      <?php endif; ?>
            ...
            <tr>
              <td colspan="7" class="text-center">
                <div style="padding: 40px 0;">
                  ...
                  <p class="mt-3 mb-0 text-success" style="font-size: 18px; font-weight: 600;">Great job! No overdue tasks.</p>
