...
<head>
  ...
  <style>
    ...
    .table tbody tr.due-today:hover {
  ...
  <main class="main-content" id="mainContent">
    ...
    <div class="card p-4">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 heading-colored">Today's Tasks</h5>
            ...
            <tr>
              <td colspan="6" class="text-center">
                <div style="padding: 40px 0;">
                  <span class="material-icons" style="font-size: 60px; color: #5bc0de;">event_available</span>
